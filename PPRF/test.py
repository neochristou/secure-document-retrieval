...
print("{} : {}".format(Eval(pk1, 1), Eval(pk2, 1)))
print("{} : {}".format(Eval(pk1, 2), Eval(pk2, 2)))
print("{} : {}".format(Eval(pk1, 222222), Eval(pk2, 222222)))
print("{} : {}".format(Eval(pk1, kw_idxs[0]), Eval(pk2, kw_idxs[0])))
print("{} : {}".format(Eval(pk1, 22222), Eval(pk2, 22222)))
print(Eval(pk1, 2))
exit()
